...
# tinyimagenet提供了200分类的txt，winds.txt，根据它创建
    file='/root/tiny-imagenet-200/val'
    with open('/root/tiny-imagenet-200/wnids.txt', 'r') as w:
    ...
    with open('/root/tiny-imagenet-200/val/val_annotations.txt', 'r') as f:
        for line in f.readlines():
            ...
            a=dirlist[0][0]
            b=imagelist[0][0]
            image_path='/root/tiny-imagenet-200/val/images'+'/'+b
            dir_path='/root/tiny-imagenet-200/val'+'/'+a
